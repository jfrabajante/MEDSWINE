...
<experiments>
  <experiment name="experiment" repetitions="2" runMetricsEveryStep="true">
    ...
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count pigs with [infected = true]</metric>
    <enumeratedValueSet variable="pig-R2">
      <value value="3"/>
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="put-pigs?">
      <value value="false"/>
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pig-R3">
      <value value="3"/>
      <value value="5"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="selling-rate">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="death-rate">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pig-R4">
      <value value="3"/>
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="buying-rate">
      <value value="3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pig-R5">
      <value value="0"/>
      <value value="3"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="pig-R1">
      <value value="5"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="Add-pigs-in-vacant-region">
      <value value="5"/>
      <value value="11"/>
    </enumeratedValueSet>
  </experiment>
