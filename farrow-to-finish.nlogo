...
<experiments>
  <experiment name="experiment" repetitions="2" runMetricsEveryStep="true">
    ...
    <go>go</go>
    <timeLimit steps="150"/>
    <metric>count piglets with [infected = true] + count sows with [infected = true]</metric>
    <enumeratedValueSet variable="death-rate-a">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="transmission-rate-a">
      <value value="50"/>
      <value value="80"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="get-pregnant?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="selling-rate-a">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="lose-immunity-s">
      <value value="0.5"/>
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Additional-pigs">
      <value value="5"/>
      <value value="10"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="selling-rate-p">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="virus-shed-a">
      <value value="50"/>
      <value value="80"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="virus-shed-p">
      <value value="50"/>
      <value value="80"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Additional-sows">
      <value value="2"/>
      <value value="4"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="transmission-rate-to-p">
      <value value="50"/>
      <value value="80"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Clean">
      <value value="&quot;off&quot;"/>
      <value value="&quot;Everyday&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="in-region">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="lose-immunity-a">
      <value value="1"/>
      <value value="2"/>
    </enumeratedValueSet>
